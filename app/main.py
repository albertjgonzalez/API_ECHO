...
from gui_components import check_endpoint, on_client_id_selected, submit, on_environment_selected
...
def fetch_status(url_entry, isapi_entry, b2b_entry, b2c_entry, muramasa_entry, url_status, isapi_status, b2b_status, b2c_status, muramasa_status):
    ...
    url_entry.after(100, lambda: submit(url_entry, isapi_entry, b2b_entry, b2c_entry, muramasa_entry, url_status, isapi_status, b2b_status, b2c_status, muramasa_status))
...
environment.set("")  # Start with no environment selected
environment_dropdown = ttk.Combobox(frame, textvariable=environment, values=["dev", "preprod", "prod"])
environment_dropdown.bind("<<ComboboxSelected>>", lambda event: on_environment_selected(client_id, environment, clients, url_entry, isapi_entry, b2b_entry, b2c_entry, muramasa_entry, url_status, isapi_status, b2b_status, b2c_status, muramasa_status))
environment_dropdown.grid(column=1, row=1, pady=5, sticky=tk.W)

url_label = ttk.Label(frame, text="B2C URL:")
...
isapi_label = ttk.Label(frame, text="B2C ISAPI:")
...
b2b_label = ttk.Label(frame, text="B2B URL:")
...
b2c_label = ttk.Label(frame, text="B2B ISAPI:")
...
submit_button = ttk.Button(frame, text="Check Status", command=lambda: fetch_status(url_entry, isapi_entry, b2b_entry, b2c_entry, muramasa_entry, url_status, isapi_status, b2b_status, b2c_status, muramasa_status))
